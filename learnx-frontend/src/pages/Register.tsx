  ...
  return (
    <div className="h-full grid place-items-center p-6">
      <form onSubmit={onSubmit} className="w-full max-w-sm bg-black/40 border border-neutral-800 rounded-xl p-6 shadow-glow">
        <h2 className="text-lg font-medium mb-4">Create your account</h2>
        ...
        <button className="w-full rounded-lg border border-neutral-700 hover:border-neutral-600 py-2">Register</button>
        <p className="text-sm text-neutral-400 mt-3">Already have an account? <Link className="underline" to="/login">Login</Link></p>
      </form>
    </div>
  )
}
